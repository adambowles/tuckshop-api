...
const categories_shared_1 = require("./services/categories/categories.shared");
const transactions_shared_1 = require("./services/transactions/transactions.shared");
const items_shared_1 = require("./services/items/items.shared");
...
const createClient = (connection, authenticationOptions = {}) => {
    ...
    client.configure(items_shared_1.itemClient);
    client.configure(transactions_shared_1.transactionClient);
    client.configure(categories_shared_1.categoryClient);
    return client;
};
