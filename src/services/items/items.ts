...
export const item = (app: Application) => {
  ...
  app.service(itemPath).hooks({
    ...
    before: {
      ...
      get: [],
      create: [
        schemaHooks.validateData(itemDataValidator),
        schemaHooks.resolveData(itemDataResolver),
      ],
      patch: [
        schemaHooks.validateData(itemPatchValidator),
        schemaHooks.resolveData(itemPatchResolver),
      ],
      remove: [],
    },
    after: {
